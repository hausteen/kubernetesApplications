...
| ---- | --------- | ------ |
| namespaceCreation | 0 | most applications need a namespace |
...
| istio | 50 | overlay networking service mesh |
| longhorn | 60 | storage |
...
| istio | needs namespaceCreation |  |
| longhorn | needs namespaceCreation |  |
| gatewayApi | needs namespaceCreation, certManager, istio |  |
